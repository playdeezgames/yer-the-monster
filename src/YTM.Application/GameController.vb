Public Class GameController
    ...
    Private Sub CreateBoilerplateStates(context As IUIContext)
        ...
        SetState(GameState.About, New AboutState(Me, AddressOf SetCurrentState, context))
        SetState(GameState.Embark, New EmbarkState(Me, AddressOf SetCurrentState, context))
        SetState(GameState.Load, New LoadState(Me, AddressOf SetCurrentState, context))
